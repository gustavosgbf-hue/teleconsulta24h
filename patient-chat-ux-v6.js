...
(function(){
  ...
  var APP_STORE_URL='https://apps.apple.com/app/consultaj%C3%A124h/id6803718849';
  function isAndroid(){return /android/i.test(navigator.userAgent||'')}
  function isNativeApp(){return !!window.ReactNativeWebView||/ConsultaJa24hApp/i.test(navigator.userAgent||'')}
  function trackAppDownload(source,store){try{window.dataLayer=window.dataLayer||[];window.dataLayer.push({event:store==='apple'?'app_store_click':'google_play_click',app_store:store==='apple'?'app_store':'google_play',source:source||'pos_consulta'})}catch(e){}}
  ...
  function mountEndAppStyle(){
    ...
    s.textContent='#s-encerrado .cj-end-cta-v6.is-app{background:linear-gradient(145deg,#102b1c,#0b1d14)!important;border-color:#315a3a!important}#s-encerrado .cj-end-store-row{display:flex;align-items:center;gap:9px;flex-wrap:wrap;margin:14px 0 5px!important}#s-encerrado .cj-end-store-badge{display:inline-flex;align-items:center;justify-content:center;text-decoration:none;line-height:0;transition:transform .16s ease,opacity .16s ease}#s-encerrado .cj-end-store-badge:hover{transform:translateY(-1px);opacity:.94}#s-encerrado .cj-end-store-badge img{display:block;height:42px;width:auto}#s-encerrado .cj-end-cta-v6__micro{display:none!important}@media(max-width:760px){#s-encerrado .cj-end-cta-v6.is-app{padding:13px!important}#s-encerrado .cj-end-cta-v6__title{font-size:17px!important}#s-encerrado .cj-end-cta-v6__sub{display:none!important}#s-encerrado .cj-end-store-row{gap:6px!important;margin:10px 0 0!important}#s-encerrado .cj-end-store-badge img{height:32px!important}#s-encerrado .cj-end-cta-v6__actions{margin-top:10px!important;padding-top:10px!important}}';
  ...
  function mountEndCTA(){
    ...
    c.innerHTML='<div class="cj-end-cta-v6__apphead"><img src="/icon-192.png" alt=""><div><div class="cj-end-cta-v6__eyebrow">APP CONSULTAJÁ24H</div><div class="cj-end-cta-v6__title">Leve a ConsultaJá24h no celular.</div></div></div><div class="cj-end-cta-v6__sub">Baixe o app para acessar consultas e documentos com mais facilidade.</div><div class="cj-end-store-row" aria-label="Baixe o aplicativo ConsultaJá24h"><a class="cj-end-store-badge" data-end="apple" href="'+APP_STORE_URL+'" target="_blank" rel="noopener" aria-label="Baixar ConsultaJá24h na App Store"><img src="/assets/store-badges/app-store.svg" alt="Baixar na App Store"></a><a class="cj-end-store-badge" data-end="play" href="'+PLAY_STORE_URL+'" target="_blank" rel="noopener" aria-label="Baixar ConsultaJá24h no Google Play"><img src="/assets/store-badges/google-play.png" alt="Disponível no Google Play"></a></div><div class="cj-end-access-guide"><div class="cj-end-access-guide__eyebrow">SEU ACESSO</div><div class="cj-end-access-guide__title">Quer guardar tudo para depois?</div><div class="cj-end-access-guide__steps"><div class="cj-end-access-guide__step"><b>1</b><span>Crie seu acesso</span></div><div class="cj-end-access-guide__step"><b>2</b><span>Entre quando precisar</span></div><div class="cj-end-access-guide__step"><b>3</b><span>Veja consultas e documentos</span></div></div><div class="cj-end-access-guide__note">O aplicativo é opcional. Seu acesso também funciona pelo navegador.</div></div><div class="cj-end-cta-v6__actions"><button type="button" class="cj-end-cta-v6__btn" data-end="area">'+(hasToken()?'Abrir minha área':'Criar meu acesso')+'</button><button type="button" class="cj-end-cta-v6__btn secondary" data-end="new">Nova consulta</button></div>';
    c.addEventListener('click',function(e){var b=e.target.closest('[data-end]');if(!b)return;var k=b.getAttribute('data-end');if(k==='play'){trackAppDownload('pos_consulta','google');return}if(k==='apple'){trackAppDownload('pos_consulta','apple');return}if(k==='area')activateAccess();else go('/consulta/?utm_source=pos_consulta&utm_medium=owned&utm_campaign=nova_consulta')});
